...
<tr><td nowrap class="bg">
	...
	<tr>
		...
		<td nowrap class="td_form_white"><input class="field" type="text" name="userTel" size="20" maxlength="20" value="<%=obj.getUserTel()%>"></td>
		</tr>
	<tr>
	...
	<tr>
	  ...
	  <td nowrap class="td_form_white"><input class="field" type="text" name="userPWD" size="30" maxlength="30" value="<%=obj.getUserPWD()%>"></td>
	  </tr>
	<tr>
	...
	<tr>
	  ...
	  <td nowrap class="td_form_white"><select name="isMgr" class="field">
	...
	<tr>
	  ...
	  <td nowrap class="td_form_white"><select class="field" name="isStop">
