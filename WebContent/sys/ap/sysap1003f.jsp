...
<tr><td nowrap class="bg">
	...
	<tr>
		<td nowrap class="td_form">不良品通報收案時效：</td>
	...
	<tr>
		<td nowrap class="td_form">廠商回覆稽催期限(黃燈)：</td>
		<td nowrap colspan="3" class="td_form_white">
			<input class="field_Q" type="text" name="field2" size="50" maxlength="100" value="<%=obj.getField2()%>">天
		</td>	
	</tr>
	<tr>
		<td nowrap class="td_form">廠商回覆稽催期限(紅燈)：</td>
		<td nowrap colspan="3" class="td_form_white">
			<input class="field_Q" type="text" name="field3" size="50" maxlength="100" value="<%=obj.getField3()%>">天
		</td>	
	</tr>
	<tr>
		<td nowrap class="td_form">歷次CAPA評估表顯示年限：</td>
		<td nowrap colspan="3" class="td_form_white">
			<input class="field_Q" type="text" name="field4" size="50" maxlength="100" value="<%=obj.getField4()%>">年
		</td>	
	</tr>
	<tr>
