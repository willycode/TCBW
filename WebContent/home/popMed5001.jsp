...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.util.Med5001DbSearch">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>
<%
String med2001Id = ESAPI.encoder().encodeForHTML(Common.get(request.getParameter("med2001Id")));

if(med2001Id != null) obj.setMed2001Id(med2001Id);
...
function popDrg5001(id){
	...
	closeReturnWindow();
	//還不確定是哪個
	returnWindow=window.open(getVirtualPath() + "tcbw/medex/medex5102f.jsp?id="+id,"",prop);
}
</script>
</head>
<body>
...
<input type="hidden" name="med2001Id" value="<%=obj.getMed2001Id()%>">
