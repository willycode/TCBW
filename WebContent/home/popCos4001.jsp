...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.util.Cos4001DbSearch">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>
<%
String cos0001Id = ESAPI.encoder().encodeForHTML(Common.get(request.getParameter("cos0001Id")));
if(cos0001Id != null) obj.setCos0001Id(cos0001Id);
...
function popDrg5001(id){
	...
	closeReturnWindow();
	returnWindow=window.open(getVirtualPath() + "tcbw/cosin/cosin0303f.jsp?v="+id,"",prop);
}
</script>
</head>
<body>
<form id="form1" name="form1" method="post" action="popCos4001.jsp" onSubmit="return checkField()">

<!--預設欄位名稱  -->
<input type="hidden" name="applNo" value="<%=obj.getApplNo()%>">
<input type="hidden" name="cos0001Id" value="<%=obj.getCos0001Id()%>">
