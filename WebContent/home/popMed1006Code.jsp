...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medse.MEDSE0004F_popCode">
...
<body>
<form id="form1" name="form1" method="post" action="popMed1006Code.jsp">
