...
<TABLE CELLPADDING=0 CELLSPACING=0>
	<TR>		
		...
		<td nowrap ID=t6 CLASS="tab_border1">諮議會評估</TD>		
...
<div>
	<table width="100%" align="center" class="table_form">
		<tr>
			<td nowrap class="td_form" width="20%">評估內容</td>
			<td nowrap class="td_form_white" style="text-align:left;" width="80%">
                <textarea name="textarea" cols="50" rows="4"></textarea>
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="20%">處理方式</td>
			<td nowrap class="td_form_white" style="text-align:left;" width="80%">
				<input type="checkbox" name="c1">啟動品質調查&nbsp;&nbsp;
				<input type="checkbox" name="c1">備查追蹤&nbsp;&nbsp;
				<input type="checkbox" name="c1">發警訊&nbsp;&nbsp;
				<input type="checkbox" name="c1">發風險溝通表&nbsp;&nbsp;
				<input type="checkbox" name="c1">修改仿單
			</td>
		</tr>
	</table>
</div> 
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',4,false);" href="#">療效不等評估結果</a></th>
	</tr>
	</thead>
	<tbody id="listTBODY">
	<%
