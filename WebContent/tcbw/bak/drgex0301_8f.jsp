...
function openDetial(){
	...
	popWinName = window.open('drgex0301_7_1f.jsp','popWinE',prop);	
}
...
<TABLE CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
	    <td nowrap ID=t8 CLASS="tab_border1">廠商回覆</TD>	    	
...
<div>
	<table width="100%" align="center" class="table_form">
		<tr>
			<td nowrap class="td_form" width="40%">製程管制與最終產品之結果檢討</td>
			<td nowrap class="td_form_white" style="text-align:left;" width="80%">
                <textarea name="textarea" cols="50" rows="2"></textarea>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td nowrap class="td_form" >一切顯著偏離或不相符(包括品質相關之客訴/回收…等)之調查及實施CAPA後成果之檢討</td>
			<td nowrap class="td_form_white" style="text-align:left;" width="80%">
                <textarea name="textarea" cols="50" rows="2"></textarea>
			</td>
		</tr>
...
<div>	
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',2,false);" href="#">製程管制與最終產品之結果檢討</a></th>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',3,false);" href="#">原料(含來源)/包材或配方變更之檢討</a></th>
	</tr>
	</thead>
	<tbody id="listTBODY">
	<%
