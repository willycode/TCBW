...
<TABLE CELLPADDING=0 CELLSPACING=0>
	<TR>		
		...
		<td nowrap ID=t6 CLASS="tab_border1">轉送評估</TD>
...
<div>
	<table width="100%" align="center" class="table_form">
		<tr>
			<td nowrap class="td_form_left" colspan="4">歷次轉送評估資訊</td>
		</tr>
		<tr>			
		...
		<tr>
			<td nowrap class="td_form_left" colspan="4">歷次轉送初評資訊</td>
		</tr>
		<tr>			
			<td nowrap class="td_form_white"  colspan="4">
               <table class="table_form" width="100%" cellspacing="0" cellpadding="0">
		...
		<tr><td nowrap><br></td></tr>
		<tr>
			<td nowrap class="td_form_left" colspan="4">歷次轉送複評資訊</td>
		</tr>
		<tr>			
			<td nowrap class="td_form_white"  colspan="4">
               <table class="table_form" width="100%" cellspacing="0" cellpadding="0">
