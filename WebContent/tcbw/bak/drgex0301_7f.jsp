...
<TABLE CELLPADDING=0 CELLSPACING=0>
	<TR>		
		...
		<td nowrap ID=t7 CLASS="tab_border1">醫院調查</TD>			
	</TR>
	<TR>
...
<div>	
	...
	<thead id="listTHEAD">
	<tr>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',1,false);" href="#">成分</a></th>
	...
	<tr >
			<td nowrap class="listTROdd"><a onclick="openDetial();">Acetaminophen</a></td>
    ...
    <tr>
			<td nowrap class="listTREven">Glimepiride</td>
			<td nowrap class="listTREven">2件</td>
			<td nowrap class="listTREven">0件</td>
			<td nowrap class="listTREven">0件</td>
			<td nowrap class="listTREven">總共2家</td>
    </tr>
	</thead>
	<tbody id="listTBODY">
	<%
