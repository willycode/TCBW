...
<TABLE CELLPADDING=0 CELLSPACING=0>
	<TR>		
		...
		<td nowrap ID=t4 CLASS="tab_border1">歷史通報</TD>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',3,false);" href="#">列管單位</a></th>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',8,false);" href="#">通報單位</a></th>
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',9,false);" href="#">附件</a></th>
	</tr>
	</thead>
	<tbody id="listTBODY">
	<%
