...
<div>
	<table width="100%" align="center" class="table_form">
		...
		<tr>
			<td nowrap class="td_form" width="20%">是否為非預期之不良事件</td>
			<td nowrap class="td_form_white" colspan="3">
		...
		<tr>
			...
			<td nowrap class="td_form_white" colspan="3">
			       字<input class="field" type="text" name="q_mean" size="10" maxlength="10" value="">
			       號<input class="field" type="text" name="q_mean" size="10" maxlength="10" value="">
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="20%">試驗醫材名稱</td>
			<td nowrap class="td_form_white" width="30%">
			     <input class="field" type="text" name="q_mean" size="10" maxlength="10" value="">
			</td>
			<td nowrap class="td_form" width="20%">器材種類</td>
			<td nowrap class="td_form_white" width="30%">
			    <%=View.getPopCode("field","q_ovrRuleInsp","","","","CM","q_ovrRuleInspCodeId","",new int[]{2,2,10,20})%>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td nowrap class="td_form" width="20%">供應商</td>
			<td nowrap class="td_form_white" width="30%">
			     <input class="field" type="text" name="q_mean" size="15" maxlength="10" value="">
			</td>
		</tr>
		...
		<tr>
			...
			<td nowrap class="td_form_white" width="30%">
			    <%=View.getPopCalendar("field","q_dateS","")%>
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="20%">醫療器材操作者</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="checkbox" name="s1">醫療人員&nbsp;&nbsp;
				<input type="checkbox" name="s1">病人或其家屬&nbsp;&nbsp;
				<input type="checkbox" name="s1">其他
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td nowrap class="td_form" width="20%">停用日期</td>
			<td nowrap class="td_form_white" colspan="3">
				<%=View.getPopCalendar("field","limitDate","")%>
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="20%">是否可提供器材作評估</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="radio" name="s4">是，取得來源<input type="text" value=""  />&nbsp;&nbsp;
				<input type="radio" name="s4">否&nbsp;&nbsp;
				<input type="radio" name="s4">已於<%=View.getPopCalendar("field","limitDate","")%>退還給廠商
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td nowrap class="td_form" width="20%">是否同時使用</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="checkbox" name="s5">中草藥*&nbsp;&nbsp;
				<input type="checkbox" name="s5">西藥*&nbsp;&nbsp;
				<input type="checkbox" name="s5">健康食品&nbsp;&nbsp;
				<input type="checkbox" name="s5">其他<input type="text" value=""  />	&nbsp;&nbsp;*若有同時使用，請填入併用藥品內◦
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td nowrap class="td_form" width="20%">試驗醫師評估醫材與SAE之因果關係</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="checkbox" name="s1">確定相關(certain)&nbsp;&nbsp;
				<input type="checkbox" name="s1">很可能相關(probable/likely)&nbsp;&nbsp;
				<input type="checkbox" name="s1">可能相關(possible)&nbsp;&nbsp;
				<input type="checkbox" name="s1">不太可能相關(unlikely)&nbsp;&nbsp;
				<input type="checkbox" name="s1">不相關(unrelated) &nbsp;&nbsp;
				<input type="checkbox" name="s1">無法評估(unknown)
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="20%">驗醫師評估手續程序與SAE之因果關係</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="checkbox" name="s1">確定相關(certain)&nbsp;&nbsp;
				<input type="checkbox" name="s1">很可能相關(probable/likely)&nbsp;&nbsp;
				<input type="checkbox" name="s1">可能相關(possible)&nbsp;&nbsp;
	    ...
	    <tr>
			<td nowrap class="td_form" width="25%">本案是否立即通知試驗委託者</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="radio" name="s1">是(且提供詳細書面報告？<input type="radio" name="s2">是<input type="radio" name="s2">否)&nbsp;&nbsp;
				<input type="radio" name="s1">否&nbsp;&nbsp;
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="25%">本案是否立即通知人體試驗委員會</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="radio" name="s3">是(且提供詳細書面報告？<input type="radio" name="s4">是<input type="radio" name="s4">否)&nbsp;&nbsp;
				<input type="radio" name="s3">否&nbsp;&nbsp;
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="25%">本案是否立即通知試驗核准單位</td>
			<td nowrap class="td_form_white" colspan="3">
				<input type="radio" name="s5">是(且提供詳細書面報告？<input type="radio" name="s6">是<input type="radio" name="s6">否)&nbsp;&nbsp;
				<input type="radio" name="s5">否&nbsp;&nbsp;
			</td>
		</tr>
	</table>
</div>  
