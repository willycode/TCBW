...
<jsp:useBean id="obj"  scope="request" class="com.kangdainfo.tcbw.view.pivot.PIVOT0701R">
...
<td>
	<table border="1" width="100%" class="table_form">
		...
		<tr>
			...
			<td class="td_form_white">
				<input class="field_Q" name="q_applicationName" size="40" value="<%=obj.getQ_applicationName()%>">
			</td>
		</tr>	
		<tr>
			<td class="td_form">製造廠：</td>
			<td class="td_form_white">
				<input class="field_Q" name="q_manufactorName" size="40" value="<%=obj.getQ_manufactorName()%>">
			</td>
		</tr>	
		<tr>
			<td class="td_form">品名：</td>
			<td class="td_form_white">
				<input class="field_Q" name="q_chProduct" size="40" value="<%=obj.getQ_chProduct()%>">
			</td>
		</tr>	
		<tr>
