...
<jsp:useBean id="obj"  scope="request" class="com.kangdainfo.tcbw.view.pivot.PIVOT0301R">
	...
	<table border="1" width="100%" class="table_form">
	    ...
	    <tr>
			...
			<td class="td_form_white">
				...
				<input class="field_Q" name="q_permitNo" size="8" value="<%=obj.getQ_permitNo()%>">
			</td>
		</tr>	
		<tr>
			<td class="td_form">持有商名稱：</td>
			<td class="td_form_white">
				<input class="field_Q" name="q_applicationName" size="50" value="<%=obj.getQ_applicationName()%>">
			</td>
		</tr>			
		<tr>
