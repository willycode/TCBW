...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="COSSE0001" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.cosse.COSSE0001F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.cosse.COSSE0001F)obj.queryOne();	
	...
	<tr>
		...
		<td nowrap class="queryTDInput">
			...
			<select class="field_Q" name="q_dpdKindB" type="select">
				<%=View.getOptionCodeKind("COSDPD", obj.getQ_dpdKindB())%>
			</select>
			小類<input class="field_Q" type="text" name="q_dpdKindS" size="4" maxlength="4" value="<%=obj.getQ_dpdKindS()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td nowrap class="td_form_white" width="65%">
			...
			<select class="field" name="dpdKindB" type="select">
				<%=View.getOptionCodeKind("COSDPD", obj.getDpdKindB())%>
			</select>
			小類<input class="field" type="text" name="dpdKindS" size="4" maxlength="4" value="<%=obj.getDpdKindS()%>">
		</td>
	</tr>
	<tr>
