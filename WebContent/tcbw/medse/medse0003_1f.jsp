...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medse.MEDSE0003_1F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.medse.MEDSE0003_1F)obj.queryOne();	
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		<td nowrap id="t1" class="tab_border2"  width="100" ><a href="#" onClick="return checkURL('medse0003f.jsp');">LEVEL1</a></td>
