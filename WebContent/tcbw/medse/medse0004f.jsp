...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medse.MEDSE0004F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.medse.MEDSE0004F)obj.queryOne();	
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<td nowrap id="t1" class="tab_border2" width="100" ><a href="#" onClick="return checkURL('medse0004_1f.jsp');">LEVEL2</a></td>		
	</tr>
	<tr>
