...
<%@ page import="com.kangdainfo.tcbw.view.medse.MEDSE0004F" %>
<%
com.kangdainfo.tcbw.view.medse.MEDSE0004F qBean = (com.kangdainfo.tcbw.view.medse.MEDSE0004F)request.getAttribute("qBean");
%>
	...
	<tr>
		...
		<td class="queryTDInput">
			<input class="field_Q" type="text" name="q_code" size="4" maxlength="4" value="<%=Common.get(qBean.getQ_code())%>">
		</td>
	</tr>
	<tr>
