...
<%
com.kangdainfo.tcbw.view.cosin.COSIN1001F qBean = (com.kangdainfo.tcbw.view.cosin.COSIN1001F) request.getAttribute("qBean");
%>
	...
	<tr>
		...
		<td nowrap class="td_form_white">
			...
			<input type="hidden" name="q_type" value="<%=qBean.getQ_type()%>">						<%--FOR 辨別分類中程式或補件中程式 --%>
		</td>
	</tr>
	
	<%
	if("1D".equals(qBean.getQ_type()) || "1A".equals(qBean.getQ_type())){	
	%>
	<tr>
	...
	<%
	if("2D".equals(qBean.getQ_type()) || "2A".equals(qBean.getQ_type())){	
	%>
	<tr>
