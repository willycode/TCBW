...
try {	
    ...
    env.setFormat("XLS");
    javax.swing.table.DefaultTableModel model = obj.getHistoryDefaultTableModel();
	if (model==null) 
	{
	...
	env.setJasperFile(this.getServletContext().getRealPath("/report/cos/COSIN0102R.jasper"));
	env.setFormat("XLS");	
