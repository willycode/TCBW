...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH" ><a class="text_link_w">廠商燈號</a></th>
		<%
		if("1S".equals(obj.getQ_type())){
		%>
		<th class="listTH" ><a class="text_link_w">衛生單位燈號</a></th>
		<%
		}
		%>
	...
	<%
	    ...
	    boolean[] displayArray = null;
	    if("1S".equals(obj.getQ_type())){
	    	displayArray = new boolean[]{false, true, true, true, true, true, true, true, true, true, true, true};
	    }else{
	    	displayArray = new boolean[]{false, true, false, true, true, true, true, true, true, true, true, true};
	    }
	//  boolean linkArray[] = {false, false, true, false, false, false, false, false, false, false, false};
	//  out.write(View.getQuerylistPlusDetailButton(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, linkArray, null, "", false, false));
		out.write(View.getQueryDiscolorList(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, "", false, "cosin0602f.jsp", "&q_type=" + obj.getQ_type(), "&userID=" + obj.getUserID() ,3));
	%>
	</tbody>
</table>
</div>
