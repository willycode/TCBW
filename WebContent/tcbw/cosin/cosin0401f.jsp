...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.cosin.COSIN0401F">
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	//  out.write(View.getQuerylistPlusDetailButton(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, linkArray, null, "", false, false));
	    out.write(View.getQueryDiscolorList(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, "", true, "cosin0402f.jsp", "", "&userID=" + obj.getUserID() ,1));
	%>
	</tbody>
</table>
</div>
