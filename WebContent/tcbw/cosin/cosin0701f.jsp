...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.cosin.COSIN0701F">
...
function updateData(id){
	...
	form1.action = "cosin0702f.jsp";
	beforeSubmit();
	form1.submit();
}

function queryOne(rowid, isNeedUpdateOther, classTR, id){
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	<thead id="listTHEAD">
	<tr>
		<th class="listTH" ><a class="text_link_w">燈號</a></th>
	...
	<%
	    ...
	    out.write(View.getQuerylist(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, null, "", "", true, false, false, "", true, true, 7));
	%>
	</tbody>
</table>
</div>
