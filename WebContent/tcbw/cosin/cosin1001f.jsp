...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<%
		if("2D".equals(obj.getQ_type()) || "2A".equals(obj.getQ_type())){
		%>
	...
	//	out.write(View.getQuerylistPlusDetailButton(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, linkArray, null, "", false, false));
		out.write(View.getQueryDiscolorList(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, "", true, "cosin1002f.jsp", "&q_type=" + obj.getQ_type(), "&userID=" + obj.getUserID() ,1));
	%>
	</tbody>
</table>
</div>
