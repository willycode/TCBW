...
function addNFoodRow(tblId,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13){
	...
	strNEdibleDate.innerHTML = '<font size="2">起</font><input type=text class=field name=nEdibleDateS' + id + ' size=7 maxlength=7 style="font-size: 10pt" value="' + (v11!=null?v11:'') + '"><button class=field style="font-size: 10px" type="button" name="btn_nEdibleDateS' + id + '" onClick="popCalendar(\'nEdibleDateS' + id + '\')" title="萬年曆輔助視窗"><image src="../../images/dynCalendar.gif"></button>' +
							   '<br>' + 
						       '<font size="2">迄</font><input type=text class=field name=nEdibleDateE' + id + ' size=7 maxlength=7 style="font-size: 10pt" value="' + (v12!=null?v12:'') + '"><button class=field style="font-size: 10px" type="button" name="btn_nEdibleDateE' + id + '" onClick="popCalendar(\'nEdibleDateE' + id + '\')" title="萬年曆輔助視窗"><image src="../../images/dynCalendar.gif"></button>';
...
function getNonPermitKey(fieldN, fieldC, fieldE){
	openCenterWindow(900, 600, "hfrex0113f.jsp?field1=" + fieldN + "&field2=" + fieldC + "&field3=" + fieldE);
}
