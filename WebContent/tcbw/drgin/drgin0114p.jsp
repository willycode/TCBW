...
try {	
	...
	javax.swing.table.DefaultTableModel model = obj.getCAPADefaultTableModel();
	if (model==null) 
	{
	...
	env.setJasperFile(this.getServletContext().getRealPath("/report/drg/DRGIN0114r.jasper"));
	env.setFormat(obj.getQ_outputFormat());	
