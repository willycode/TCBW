...
<%@ page import="java.io.*"%>
<jsp:useBean id="obj"  scope="request" class="com.kangdainfo.tcbw.view.pmed.PMED0301F">
...
try {	
	...
	if("01".equals(obj.getReportType())){
		env.setWordFile(this.getServletContext().getRealPath("/word/pmed/PMED0401_01.mht"));
	}
