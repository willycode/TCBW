...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.pmed.PMED0201Q">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>
<%
String type = Common.get(request.getParameter("caseType"));
obj.setCaseType(type);
...
{
	obj = (com.kangdainfo.tcbw.view.pmed.PMED0201Q)obj.queryOne();
}
obj.setQueryAllFlag("true"); 
...
<tr><td nowrap class="bg">
	...
	<tr>
		...
		<td nowrap class="td_form_white" width="35%" colspan="3">
