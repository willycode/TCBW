...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VMED0401Q" />
</jsp:include>
...
<tr><td nowrap class="bg">
	...
	<tr>
	    <td nowrap class="td_form">本許可證是否為警訊容產品</td>
		<td nowrap class="td_form_white">
			<input class="field_Q" type="radio">是
			<input class="field_Q" type="radio">否
		</td>
