...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VMED0301" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.vmed.VMED0301F">
...
obj.setUserID(Common.get(User.getId()));

if ("queryAll".equals(obj.getState())) {
	if ("false".equals(obj.getQueryAllFlag())){obj.setQueryAllFlag("true"); }
}else if ("queryOne".equals(obj.getState())) {
	obj = (com.kangdainfo.tcbw.view.vmed.VMED0301F)obj.queryOne();	
...
function toCreateForm()
{
	...
	form1.action = "vmed0100f.jsp?formType=0301";
	form1.submit();
}
</script>
</head>
...
<tr><td class="bg">
	...
	<jsp:include page="vmed0301q.jsp" />
	</div>
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
		...
		out.write(View.getQueryDiscolorList(primaryArray, displayArray,null, objList, obj.getQueryAllFlag(), true, "", true,"vmed0100f.jsp","&formType=0301","",1));
	%>
	</tbody>
</table>
</div>
