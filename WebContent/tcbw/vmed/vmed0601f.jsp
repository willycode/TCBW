...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VMED0601" />
</jsp:include>
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.vmed.VMED0601F)obj.queryOne();	
...
<tr><td class="bg">
	...
	<jsp:include page="vmed0601q.jsp" />
	</div>
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
		...
		out.write(View.getQueryDiscolorList(primaryArray, displayArray,null, objList, obj.getQueryAllFlag(), true, "", true,"vmed0100f.jsp","&formType=0601","",1));
	%>
	</tbody>
</table>
</div>
