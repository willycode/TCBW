...
if("doConfirm".equals(obj.getState())) 
{
	try
	{
		obj.doReNoticerevision(id);
		obj.setErrorMsg("公告改版完成");
	}
	catch(Exception e)
	{
		e.printStackTrace();
...
{	
	var alertStr = "";
	alertStr += checkEmpty(form1.changereason, "改版原因");
	if(alertStr.length!=0){ alert(alertStr); return false; }
	form1.submit();
	//alert("公告改版完成!!");
	window.close();
	opener.doBack();//返回查詢頁面
	//return true;
}
...
<tr>
	...
	<table class="table_form" width="100%" height="100%">
		<tr>
			<td nowrap class="td_form" width="15%">改版原因</td>
