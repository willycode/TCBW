...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VMED0501" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.vmed.VMED0501F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.vmed.VMED0501F)obj.queryOne();	
...
<tr><td class="bg">
	...
	<jsp:include page="vmed0501q.jsp" />
	</div>
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
		...
		out.write(View.getQueryDiscolorList(primaryArray, displayArray,null, objList, obj.getQueryAllFlag(), true, "", true,"vmed0100f.jsp","&formType=0501","",1));
	%>
	</tbody>
</table>
</div>
