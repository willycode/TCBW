...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VMED1301" />
</jsp:include>
...
<%
	...
	obj = (com.kangdainfo.tcbw.view.vmed.VMED1301F)obj.queryOne();	
...
<tr><td class="bg">
	...
	<jsp:include page="vmed1301q.jsp" />
	</div>
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
		...
		out.write(View.getQueryDiscolorList(primaryArray, displayArray,null, objList, obj.getQueryAllFlag(), true, "", true,"vmed0100f.jsp","&formType=1301","",1));
	%>
	</tbody>
</table>
</div>
