...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conse.CONSE0007_1F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.conse.CONSE0007_1F)obj.queryOne();	
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		<td nowrap id="t1" class="tab_border2"  width="100" height="25"><a href="#" onClick="return checkURL('conse0007f.jsp');">	廠商基本資料</a></td>
...
<tr><td nowrap class="bg">
	...
	<tr>
		<td nowrap class="td_form">緊急聯絡人：</td>
	  	<td nowrap class="td_form_white">
	  		<input class="field" type="checkbox" name="isECP" <%if("Y".equals(obj.getIsECP())) out.write("checked"); %> value="Y">
	  	</td>
	</tr>
	<tr>
		<td nowrap class="td_form">廠商管理者：</td>
	  	<td nowrap class="td_form_white">
	  		<input class="field" type="checkbox" name="isAdmin" <%if("Y".equals(obj.getIsAdmin())) out.write("checked"); %> value="Y">
	  	</td>
	</tr>
	<tr>
