...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONSE0004" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conse.CONSE0004F">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
if (obj.getState().equals("importZipCode") && !"".equals(obj.getQ_filePath())) {
	try{
		obj.importZipCode();
...
function checkField(){
	...
	form1.state.value = "importZipCode";
	form1.submit();
	return true;
}
</script>
...
<div id="formContainer">
	...
	<tr>
  		<td nowrap class="td_form"><font color="red">*</font>郵遞區號檔案：</td>
