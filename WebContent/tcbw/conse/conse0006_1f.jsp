...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conse.CONSE0006_1F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.conse.CONSE0006_1F)obj.queryOne();	
...
var insertDefault = new Array(
		new Array("unionName", '<%=obj.getUnionName()%>')
	);
function checkField(){
	var alertStr = "";
	var isShow = "";
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		<td nowrap id="t1" class="tab_border2"  width="100" height="25"><a href="#" onClick="return checkURL('conse0006f.jsp');">衛生單位資料</a></td>
		<td nowrap id="t1" class="tab_border1" width="100">衛生單位人員</td>		
	</tr>
	<tr>
...
<tr><td nowrap class="bg">
	...
	<tr>
		...
		<td nowrap class="td_form_white" width="65%">
			<input class="field_RO" type="text" name="unionName" size="50" maxlength="50" value="<%=obj.getUnionName()%>">
		</td>
	</tr>
	<tr>
