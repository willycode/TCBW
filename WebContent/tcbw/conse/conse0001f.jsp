...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONSE0001" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conse.CONSE0001F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.conse.CONSE0001F)obj.queryOne();	
...
function checkField(){
	...
	if(form1.state.value == "queryAll"){
		...
		alertStr += checkEmpty(form1.formID, "表單編號");
		alertStr += checkEmpty(form1.title, "主旨");
		alertStr += checkEmpty(form1.mailID, "郵件編號");
		
		//alertStr += checkEmpty(form1.mailBody, "內容");
		//if(form1.mailBody.value != "")
		//{
			//alertStr += checkLen(form1.mailBody, "內容", 1000);
		//}
	}
...
<div id="queryContainer" style="width:500px;height:150px;display:none">
	...
	<tr>
		...
		<td nowrap class="queryTDInput">
			<select class="field_Q" name="q_systemType" onchange="setValue(this,q_formID);">
				<%=View.getOptionCodeKind("SYS", obj.getQ_systemType())%>
			</select>
		</td>
	</tr>
	<tr>
		<td nowrap class="queryTDLable">表單：</td>
		<td nowrap class="queryTDInput">
		    <select name="q_formID" class="field" >
	...
	<tr>
		<td nowrap class="queryTDLable">郵件編號：</td>
		<td nowrap class="queryTDInput">
			<input class="field_Q" type="text" name="q_mailID" size="20" maxlength="10" value="<%=obj.getQ_mailID()%>">
		</td>
	</tr>
	<tr>
...
<tr><td nowrap class="bg">
	...
	<tr>
		<td nowrap class="td_form" width="15%"><font color="red">*</font>系統別：</td>
		<td nowrap class="td_form_white" width="85%">
			<select class="field" name="systemType" onchange="setValue(this,formID);">
				<%=View.getOptionCodeKind("SYS", obj.getSystemType())%>
			</select>
		</td>
	</tr>
	<tr>
	  	<td nowrap class="td_form"><font color="red">*</font>表單：</td>
	  	<td nowrap class="td_form_white">
	  	    <select name="formID" class="field" >
	    		<%=View.getOption("select id,formdName from Con1007Db",obj.getFormID(),false,1)%>
	    	</select>
	  	</td>
	</tr>
	<tr>
	  	<td nowrap class="td_form"><font color="red">*</font>郵件編號：</td>
	  	<td nowrap class="td_form_white">
	    <input class="field" type="text" name="mailID" size="20" maxlength="9" value="<%=obj.getMailID()%>">
	</td>
	</tr>
	<tr>
	  	<td nowrap class="td_form"><font color="red">*</font>主旨：</td>
	  	<td nowrap class="td_form_white">
	  		<input class="field" type="text" name="title" size="50" maxlength="100" value="<%=obj.getTitle()%>">
	  	</td>
	</tr>
	<tr>
...
<table class="table_form" width="99%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',2,false);" href="#">表單</a></th>
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',3,false);" href="#">郵件編號</a></th>
