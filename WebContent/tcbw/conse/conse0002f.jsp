...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONSE0002" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conse.CONSE0002F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.conse.CONSE0002F)obj.queryOne();	
...
function checkField(){
	...
	if(form1.state.value == "queryAll"){
		...
		alertStr += checkEmpty(form1.formCodeB, "系統別");
		alertStr += checkEmpty(form1.formCodeS, "通報表單代碼");
		alertStr += checkEmpty(form1.formdName, "通報表單名稱");
...
<div id="queryContainer" style="width:500px;height:150px;display:none">
	...
	<tr>
		...
		<td nowrap class="queryTDInput">
			<select class="field_Q" name="q_formCodeB" type="select">
				<%=View.getOptionCodeKind("SYS", obj.getQ_formCodeB())%>
			</select>
		</td>
	</tr>
	<tr>
		<td nowrap class="queryTDLable">通報表單代碼：</td>
		<td nowrap class="queryTDInput">
			<input class="field_Q" type="text" name="q_formCodeS" size="2" maxlength="2" value="<%=obj.getQ_formCodeS()%>">
		</td>
	</tr>
	<tr>
		<td nowrap class="queryTDLable">通報表單名稱：</td>
		<td nowrap class="queryTDInput">
			<input class="field_Q" type="text" name="q_formdName" size="50" maxlength="50" value="<%=obj.getQ_formdName()%>">
		</td>
	</tr>
	<tr>
...
<tr><td nowrap class="bg">
	...
	<tr>
		...
		<td nowrap class="td_form_white" width="65%">
			<select class="field" name="formCodeB" type="select">
				<%=View.getOptionCodeKind("SYS", obj.getFormCodeB())%>
			</select>
		</td>
	</tr>
	<tr>
		<td nowrap class="td_form" width="35%"><font color="red">*</font>通報表單代碼：</td>
		<td nowrap class="td_form_white" width="65%">
			<input class="field" type="text" name="formCodeS" size="2" maxlength="2" value="<%=obj.getFormCodeS()%>">
		</td>
	</tr>
	<tr>
	  	<td nowrap class="td_form"><font color="red">*</font>通報表單名稱：</td>
	  	<td nowrap class="td_form_white">
	  		<input class="field" type="text" name="formdName" size="50" maxlength="50" value="<%=obj.getFormdName()%>">
	  	</td>
	</tr>
	<tr>
...
<table class="table_form" width="99%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',2,false);" href="#">通報表單代碼</a></th>
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',3,false);" href="#">通報表單名稱</a></th>
