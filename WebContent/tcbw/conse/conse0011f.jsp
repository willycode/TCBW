...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONSE0011" />
</jsp:include>
...
function checkField(){
	...
	if(form1.state.value == "queryAll"){
		...
		alertStr += checkEmpty(form1.formType, "聲明類別");
		alertStr += checkEmpty(form1.formName, "表單聲明名稱");
	}
...
<div id="queryContainer" style="width:800px;height:150px;display:none">
	...
	<tr>
		<td nowrap class="queryTDLable">表單聲明名稱：</td>
		<td nowrap class="queryTDInput">
			<input class="field_Q" type="text" name="q_formName" size="10" maxlength="2" value="<%=obj.getQ_formName()%>">		
		</td>
	</tr>
	<tr>
...
<tr><td nowrap class="bg">
	...
	<tr>
		<td nowrap class="td_form" ><font color="red">*</font>聲明類別：</td>
		<td nowrap class="td_form_white" >
			<input class="field" type="text" name="formType" size="10" maxlength="2" value="<%=obj.getFormType()%>">				
		</td>
	</tr>	
	<tr>
		<td nowrap class="td_form" ><font color="red">*</font>表單聲明名稱：</td>
		<td nowrap class="td_form_white" >
			<input class="field" type="text" name="formName" size="50" maxlength="50" value="<%=obj.getFormName()%>">				
		</td>
	</tr>
	<tr>
		<td nowrap class="td_form" ></font>聲明內容：</td>
		<td nowrap class="td_form_white" >
		<textarea class="field" name="formDesc" cols="100" rows="20"><%=obj.getFormDesc()%></textarea>				
		</td>
	</tr>	
	<tr>
...
<table class="table_form" width="99%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',2,false);" href="#">聲明類別</a></th>
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',3,false);" href="#">表單聲明名稱</a></th>
	</tr>
	</thead>
	<tbody id="listTBODY">
	<%
