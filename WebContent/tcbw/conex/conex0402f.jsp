...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONEX0401" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conex.CONEX0402F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.conex.CONEX0402F)obj.queryOne();	
...
function init() {
	if("Y"==form1.isAdmin.value)	
		setDisplayItem('spanInsert,spanQueryAll','H');
	else{
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		<td nowrap id="t1" class="tab_border2"  width="100" height="25"><a href="#" onClick="return checkURL('conex0401f.jsp');">	廠商基本資料</a></td>
		<td nowrap id="t1" class="tab_border1" width="100">廠商人員</td>		
	</tr>
	<tr>
...
<tr><td nowrap class="bg">
	...
	<tr>
		...
		--%>
		    <input class="field_RO" type="text" name="usernameid" size="10" maxlength="10" value="<%=obj.getUsernameid()%>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td nowrap class="td_form">緊急聯絡人：</td>
	  	<td nowrap class="td_form_white">
	  		<input class="field_Q" type="checkbox" name="isECP" <%if("Y".equals(obj.getIsECP())) out.write("checked"); %> value="Y">
	  	</td>
	</tr>
	<tr>
	  	<td nowrap class="td_form"><font color="red">*</font>表單別：</td>
	  	<td nowrap class="td_form_white">
	  		<%=View.getCon1007CheckBoxTextOption("field","formType",obj.getFormType(),"'MED04'")%>
	  	</td>
	</tr>
	<tr>
...
<tr><td nowrap class="bgToolbar" style="text-align:center">
	...
	<input type="hidden" name="isAdmin" value="<%=obj.getIsAdmin()%>">
...
<table class="table_form" width="99%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',6,false);" href="#">緊急聯絡人</a></th>
	</tr>
	</thead>
	<tbody id="listTBODY">
	<%
