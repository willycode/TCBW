...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conex.CONEX0401F">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<jsp:useBean id="objList" scope="page" class="java.util.ArrayList"/>
<%
if("init".equals(obj.getState())){
	obj.setState("queryAll"); 
}
...
if ("queryAll".equals(obj.getState())) {	
	...
	obj = (com.kangdainfo.tcbw.view.conex.CONEX0401F)obj.queryOne();	
}
/**
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<td nowrap id="t1" class="tab_border2" width="100"><a href="#" onClick="return checkURL('conex0402f.jsp');">廠商人員</a></td>		
	</tr>
	<tr>
