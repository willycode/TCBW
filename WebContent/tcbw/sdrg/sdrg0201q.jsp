...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.sdrg.SDRG0201Q">
...
<td nowrap class="bg">
	...
	<jsp:include page="sdrg0201q1.jsp" />
	</div>
</td>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
	    ...
	    out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", true,"sdrg0201f.jsp","","",1));
	%>
	</tbody>
</table>
</div>
