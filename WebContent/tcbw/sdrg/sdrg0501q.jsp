...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.sdrg.SDRG0501Q">
...
<td nowrap class="bg">
	...
	<jsp:include page="sdrg0501q1.jsp" />
	</div>
</td>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
	    ...
	    out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", false,"sdrg0501f.jsp","&caseType="+caseType,"",2));
	%>
	</tbody>
</table>
</div>
