...
<%
com.kangdainfo.tcbw.view.sdrg.SDRG0701Q qBean = (com.kangdainfo.tcbw.view.sdrg.SDRG0701Q) request.getAttribute("qBean");
%>
	...
	<tr>
		...
		<select name="q_permitKey" class="field_Q" >
		    <%=View.getOptionCodeKind("DRGPKID", qBean.getQ_permitKey())%>
   			...
   			<input class="field_Q" type="text" name="q_permitNo" size="10" maxlength="15" value="<%=qBean.getQ_permitNo()%>" />
		</td>
		<td nowrap class="td_form" >案件狀態：</td>
	    <td nowrap class="td_form_white">
	        <select name="q_status" class="field_Q">
			    <%=View.getOptionCodeKind("DRGEVSTATUS", qBean.getQ_status())%>
		    </select>
     	</td>
		</tr>			
	<tr>
