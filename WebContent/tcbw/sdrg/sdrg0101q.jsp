...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.sdrg.SDRG0101Q">
...
<tr>
	 ...
	 <input type="hidden" name="caseType" value="<%=obj.getCaseType()%>">  	
		<span id="toCreate">
			<input class="toolbar_default" type="button" followPK="false"  name="toCreate1" value="開 始 通 報"  onClick="toCreate();">
		</span>
...
<td nowrap class="bg">
	...
	<jsp:include page="sdrg0101q1.jsp" />
	</div>
</td>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	<thead id="listTHEAD">
		<tr>
			...
			<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',6,false);" href="#">許可證持有商</a></th>
			<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',7,false);" href="#">發文日期</a></th>
			<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',8,false);" href="#">回收文號</a></th>
			<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',9,false);" href="#">訊息來源</a></th>
			<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',10,false);" href="#">回收期限</a></th>
			<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',11,false);" href="#">主管衛生局</a></th>
	...
	<%
	    ...
	    out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", true,"sdrg0101f.jsp","&caseType="+caseType,"",1));
	%>
	</tbody>
</table>
</div>
