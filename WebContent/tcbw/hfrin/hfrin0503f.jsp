...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0503F">
...
obj = (com.kangdainfo.tcbw.view.hfrin.HFRIN0503F)obj.queryOne();
%>
<html>
<head>
...
localButtonFireListener.whatButtonFireEvent = function(buttonName){
	...
	case "pageUpdate":
		...
		if(flag){
			...
			chUnHealthIsYes("<%=obj.getUnHealthIsYes()%>");
			chAgainEatingHealthFood("<%=obj.getAgainEatingHealthFood()%>");
			chDrugAllergies("<%=obj.getDrugAllergies()%>");
			chFoodAllergies("<%=obj.getFoodAllergies()%>");
			chDiseaseHistory();
			chLifeHistory();
		}
		break;
