...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0501F">
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" href="#">英文品名</a></th>
	...
	//	out.write(View.getQuerylistPlusDetailButton(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, null, null, "", false, false));
		out.write(View.getQueryDiscolorList(primaryArray, displayArray, null, objList, obj.getQueryAllFlag(), true, "", true, "", "&hfrType=", "&userID=" + obj.getUserID(), -1, 8, new String[]{"", "hfrin0502f.jsp", "hfrin0503f.jsp"}));
	%>
	</tbody>
</table>
</div>
