...
<%
	...
	try{
		...
		java.util.List listCount = obj.getHealthCout(); 
		com.kangdainfo.common.util.XlsUtil xlsUtil = new com.kangdainfo.common.util.XlsUtil();
		java.io.File file = xlsUtil.genXlsFile(list, listCount);
		fis = new java.io.FileInputStream(file); 
		out.clear();

		response.setContentType("application/octet-stream; charset=iso-8859-1;");
		response.setHeader("content-disposition","attachment; filename="+"HFRIN0201R.xls");
