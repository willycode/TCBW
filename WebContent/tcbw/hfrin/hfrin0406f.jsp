...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0403F">
...
obj = (com.kangdainfo.tcbw.view.hfrin.HFRIN0403F)obj.queryOne();
%>
<html>
<head>
...
function init() {
	if("<%=obj.getIsNeedBackQuery()%>" == "N" || "<%=obj.getIsNeedBackQuery()%>" == ""){
		...
		chDiseaseHistory();
		chLifeHistory();
		updateEaters("<%=obj.getIsSameNotifier()%>", "N");
		$("#notifier9").hide();
