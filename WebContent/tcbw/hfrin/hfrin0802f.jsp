...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0802F">
...
obj = (com.kangdainfo.tcbw.view.hfrin.HFRIN0802F)obj.queryOne();
%>
<html>
<head>
...
<tr>
	...
	%>
	<td ID="t8" CLASS="tab_border2"><a id="aTab8" href="#" onClick="changeTab(8);">預評作業</a></td>
	<%
	}
	%>
	<td ID="t5" CLASS="tab_border2"><a id="aTab5" href="#" onClick="changeTab(5);">複評頁籤</a></td>
	<td ID="t9" CLASS="tab_border2"><a id="aTab9" href="#" onClick="changeTab(9);">歷史通報</a></td>
</tr>
</TABLE>
