...
com.kangdainfo.tcbw.view.hfrin.HFRIN0001F qBean = (com.kangdainfo.tcbw.view.hfrin.HFRIN0001F) request.getAttribute("qBean");
%>
...
function getUser(){
	openCenterWindow(800, 500, 'hfrin0411f.jsp?q_type=E');
}
	...
	<tr><td>
		...
		<tr>
			<td nowrap class="td_form">通報者電話</td>
		  	<td nowrap class="td_form_white">
				...
				- <input class="field_RO" type="text" id="notifier3" name="notifierTel" size="10" maxlength="10" value="<%=qBean.getNotifierTel()%>">
		...
		<tr>
			...
			<td nowrap class="td_form_white" colspan="3">
				<input class="field_RO" type="text" id="notifier5" name="notifierEamil" size="50" maxlength="50" value="<%=qBean.getNotifierEamil()%>">
			</td>
		</tr>
		<tr>
