...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0303F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.hfrin.HFRIN0303F)obj.queryOne();	
...
function checkField(){
	...
	if(form1.state.value == "queryAll"){
		...
		alertStr += checkEmpty(form1.caseno, "案件編號");
	}
...
function popHFR0006(nameField, idField){
	var jscript = "";	
	var prop = "";
	...
	closeReturnWindow();
	returnWindow=window.open(getVirtualPath() + "home/popHFR0006.jsp?nameField="+nameField+"&idField="+idField,"",prop);
}
...
<table cellpadding="0" cellspacing="0" valign="top">
	<tr>
		...
		<td nowrap id="t1" class="tab_border1" width="100">評估案件維護作業</td>			
	</tr>
	<tr>
...
<tr><td nowrap class="bg">
	...
	<tr>
		<td nowrap class="td_form"><font color="red">*</font>案件編號：</td>
		<td nowrap class="td_form_white" colspan="3">
			<%=obj.getPopHfr0006("field", "caseno", obj.getCaseno(), obj.getId())%>
		</td>
	</tr>
	<tr>
		<td nowrap class="td_form">案件狀態：</td>
		<td nowrap class="td_form_white"  colspan="3">
		<select name="casestatus" class="field_RO" type="select" >
	    		<%=View.getOptionCodeKind("FCS", obj.getCasestatus())%>
	    </select>
...
<tr><td nowrap class="bgToolbar" style="text-align:center">
	...
	<input type="hidden" name="detailid2" value="<%=obj.getDetailid2()%>">
