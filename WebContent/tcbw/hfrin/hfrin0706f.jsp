...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0705F">
...
obj = (com.kangdainfo.tcbw.view.hfrin.HFRIN0705F)obj.queryOne();
%>
<html>
<head>
