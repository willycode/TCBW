...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.hfrin.HFRIN0603F">
...
obj = (com.kangdainfo.tcbw.view.hfrin.HFRIN0603F)obj.queryOne();
%>
<html>
<head>
...
function checkHFR0006FDate(){
	var alertStr = "";
	$("#Tab2 tr[id*=hfr0005Db] :text[name$=Date][class=field],#Tab5 :text[name$=Date][class=field]").each(function(){		
...
<tr>
	...
	<td ID="t6" CLASS="tab_border2"><a id="aTab6" href="#" onClick="changeTab(6);">歷史通報</a></td>
</tr>
</TABLE>
