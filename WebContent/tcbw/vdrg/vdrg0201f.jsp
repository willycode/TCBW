...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VDRG0201" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.vdrg.VDRG0201F">
...
if ("init".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.vdrg.VDRG0201F)obj.queryOne();	
...
<tr><td class="bg">
	...
	<jsp:include page="vdrg0201q.jsp" />
	</div>
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	String[] alignArray  =  {"center","center","center","center","left","left","left","left"};
	out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", true,"vdrg0100f.jsp","&formType=0201","",1));
	%>
	</tbody>
</table>
</div>
