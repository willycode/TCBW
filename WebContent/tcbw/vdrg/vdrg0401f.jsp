...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="VDRG0401" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.vdrg.VDRG0401F">
...
if ("init".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.vdrg.VDRG0401F)obj.queryOne();	
...
<tr><td class="bg">
	...
	<jsp:include page="vdrg0401q.jsp" />
	</div>
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", true,"vdrg0100f.jsp","&formType=0401","",1));
	%>
	</tbody>
</table>
</div>
