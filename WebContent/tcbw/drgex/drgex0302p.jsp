...
try {	
	...
	javax.swing.table.DefaultTableModel model = obj.getDefaultTableModel(null);
	if (model==null) 
	{
	...
	env.setJasperFile(this.getServletContext().getRealPath("/report/drg/DRGIN0302tir.jasper"));
	env.setFormat(obj.getQ_outputFormat());	
