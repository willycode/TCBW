...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.drgex.DRGEX0304F">
...
<tr><td class="bgToolbar" style="text-align:left">
	...
	<input class="toolbar_default" type="submit" followPK="false" name="doSend" id="doSend" value="批次上傳" onClick="doUpdate();">&nbsp;
</td></tr>
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',6,false);" href="#">學名</a></th>
		<th class="listTH"><a class="text_link_w" onclick="return sortTable('listTBODY',7,false);" href="#">商品名</a></th>
	...
	out.write(View.getCheckboxQuerylist(primaryArray,displayArray,null,objList,obj.getQueryAllFlag(),"ids",null,null,"field_Q"));
	%>
	</tbody>
</table>
</div>
