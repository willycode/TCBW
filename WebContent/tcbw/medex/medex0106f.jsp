...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medex.MEDEX0106F">
...
{
   obj = (com.kangdainfo.tcbw.view.medex.MEDEX0106F)obj.queryOne();	
}
%>
...
function init() 
{
	...
	{
		window.opener.location.href = "medex0101f.jsp?q_status=30";
		window.close();
	}
}
...
<table width="100%" cellspacing="0" cellpadding="0">	
	...
	<tr>
		...
		<%=Common.FormatStr(obj.getNotifyBody(),"Y")%>
		</td>		
	</tr>
	<tr>
