...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="COMPLE0501" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.comple.COMPLE0501F">
...
{
	obj = (com.kangdainfo.tcbw.view.comple.COMPLE0501F)obj.queryOne();
}
