...
var popWinName = null;
function getUser(){
	openCenterWindow(800, 500, '../hfrin/hfrin0411f.jsp?q_type=C');
}
...
function checkHFR0002FDate(){
	...
	<tr><td>
		...
		<tr>
			...
			<td nowrap class="td_form_white">
				<input class="field" type="text" id="notifier2" name="notifierIdNum" size="20" maxlength="10" value="<%=qBean.getNotifierIdNum()%>">
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form">電話</td>
		  	<td nowrap class="td_form_white">
		  		( <input class="field" type="text" id="notifier3" name="notifierTelArea" size="2" maxlength="2" value="<%=qBean.getNotifierTelArea()%>"> )
				- <input class="field" type="text" id="notifier4" name="notifierTel" size="10" maxlength="10" value="<%=qBean.getNotifierTel()%>">
				# <input class="field" type="text" id="notifier5" name="notifierTelExt" size="3" maxlength="3" value="<%=qBean.getNotifierTelExt()%>">
			</td>
			<td nowrap class="td_form">電子郵件信箱</td>
			<td nowrap class="td_form_white">
				<input class="field" type="text" id="notifier6" name="notifierEamil" size="30" maxlength="50" value="<%=qBean.getNotifierEamil()%>">
			</td>
		</tr>
		<tr>
			<td nowrap class="td_form">屬性</td>
			<td nowrap class="td_form_white" >
				<%=View.getCommonCodeRadioBoxOption("field", "notifierType", "CONNFT1", qBean.getNotifierType(), null, "02,03,04", "notifier7") %>
			</td>
		...
		<tr>
			...
			<td nowrap class="td_form_white">
				<select class="field" id="notifier10" name="notifierTitle" type="select">
		...
		<tr>
			<td nowrap class="td_form">住址</td>
		  	<td nowrap class="td_form_white" colspan="3">
				<select class="field" id="notifier11" name="notifierArea" type="select" onChange="popZipCode(this,notifierZipCode);">
			       <%=View.getOptionCodeKind("CTY", qBean.getNotifierArea())%>
			    </select>
			    <select class="field" id="notifier12" name="notifierZipCode" type="select">
				   <%=View.getOptionCon1002(qBean.getNotifierZipCode())%>
			    </select>
				<input class="field" type="text" id="notifier13" name="address" size="50" maxlength="100" value="<%=qBean.getAddress()%>">
			</td>
		</tr>
		...
		<tr id="tr0002">
			...
			<td nowrap class="td_form">身分證字號</td>
			<td nowrap class="td_form_white">
				<input class="field" type="text"  id="eater2" name="eatersIdNum" size="20" maxlength="10">
			</td>
		</tr>
		<tr id="tr0003">
	...
	<tr><td>
		...
		<tr>
			<td nowrap class="td_form_white" colspan="4">
				<jsp:include page="../hfrin/hfrin0409f.jsp">
