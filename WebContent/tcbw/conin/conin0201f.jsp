...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONIN0201" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conin.CONIN0201F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.conin.CONIN0201F)obj.queryOne();	
...
<TABLE CELLPADDING=0 CELLSPACING=0 valign="top">
	<tr>
		...
		<td nowrap ID=t2 CLASS="tab_border2" width="100"><a href="#" onClick="return checkURL('conin0401f.jsp');">身分別權限</a></td>
	</tr>
	<tr>
