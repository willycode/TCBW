...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conin.CONIN0902F">
	<jsp:setProperty name="obj" property="*"/>
</jsp:useBean>
<%
String sys_id = "-11"; 
if (obj.getState().equals("submit")){
	obj.updateAuth();
}
%>
...
<input type="hidden" name="subSystem" value="<%=obj.getSubSystem()%>">
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0>
	<tr>
		<td nowrap ID=t1 CLASS="tab_border2" width="100"><a href="#" onClick="return checkURL('conin0901f.jsp');">身分別資料</a></td>
		<td nowrap ID=t2 CLASS="tab_border1" width="100" HEIGHT="25">群組人員</td>
		<td nowrap>&nbsp;</td>
	</tr>
	<tr>
...
<tr><td nowrap>
    ...
    <tr>	
    	<td nowrap class="td_form" width="100">身分別名稱：</td>
        <td nowrap class="td_form_white">
            <%=obj.getGroupName()%>
        </td>
        <td nowrap class="td_form" width="100">身分別描述：</td>
        <td nowrap class="td_form_white">
            <%=obj.getGroupDesc()%>
        </td>
    </tr>
...
<table border="1" width="100%">
	<tr>
		...
		<div id="d" class="dtree">
			<a href="javascript: d.openAll();"><%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(application.getInitParameter("open_all"))%></a> | <a href="javascript: d.closeAll();"><%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(application.getInitParameter("close_all"))%></a><br /><br />
...
//				<!--
				...
				<%=ServiceGetter.getInstance().getCommonService().getCommonUserDao().buildCheckBoxTree("d", "請選擇要授權人員的項目", "auth", "d", "d.checkBoxClick", sys_id, obj.getId(), UserRole, true, false, false)%>		
		...
		<td nowrap align="center" valign="top">
			...
			<tr>
				...
				<tr>
					<td nowrap colspan="2" align="center" class="td_lable">權限種類</td>
				</tr>
				<tr>
					<td nowrap>
						<input type="radio" name="authoritytype" value="1" >
					</td>
					<td nowrap>
						<span class="query"><span class="auth1">查詢權限</span></span>
					</td>
				</tr>
				<tr>
					<td nowrap>
						<input type="radio" name="authoritytype" value="2" checked>
					</td>
					<td nowrap>
						<span class="auth2">維護權限</span>
					</td>
				</tr>
				</table>
				<br>
		...
		<div id="s" class="dtree">
			<a href="javascript: s.openAll();"><%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(application.getInitParameter("open_all"))%></a> | <a href="javascript: s.closeAll();"><%=org.apache.commons.lang.StringEscapeUtils.escapeHtml(application.getInitParameter("close_all"))%></a><br /><br />
			<script type="text/javascript" language="javascript">
				...
				<%=ServiceGetter.getInstance().getCommonService().getCommonUserDao().buildCheckBoxTree("s", "已授權人員項目", "authed", "s", "s.checkBoxClick", sys_id, obj.getId(), UserRole, false, false, false)%>		
				document.write(s);
				//-->
			</script>
		</div>
