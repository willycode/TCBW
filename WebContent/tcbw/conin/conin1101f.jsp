...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="CONIN1101" />
</jsp:include>
--%>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conin.CONIN1101F">
...
if("queryAll".equals(obj.getState())){
	...
	obj = (com.kangdainfo.tcbw.view.conin.CONIN1101F)obj.queryOne();
}
	...
	<table class="queryTable" border="1">
		<tr>
			...
			<td nowrap class="queryTDInput">
				<select class="field_Q" name="q_permitKey" type="select" style="width:100px">					
					<%= View.getTextOption("a;1.a;b;2.b;c;3.c",obj.getQ_permitKey(),2) %>
				</select>
				字
				<input class="field_Q" type="text" name="q_permitNo" size="20" maxlength="6" value="<%= obj.getQ_permitNo()%>">
				號
			</td>
		</tr>
		<tr>
			<td nowrap class="queryTDLable">產品名稱</td>
			<td nowrap class="queryTDInput">
			...
			<table class="table_form" width="100%" height="100%">
				<tr>
					...
					<td nowrap class="td_form_white">
						<select class="field" name="permitKey" type="select" style="width:100px">
							<%= View.getTextOption("a;1.a;b;2.b;c;3.c",obj.getPermitKey(),2) %>
						</select>
						字
						<input class="field" type="text" name="permitNo" maxlength="6" value="<%= obj.getPermitNo() %>">
						號
					</td>
					<tr>
					...
					<tr>
						...
						<td nowrap class="td_form_white">
							<textarea class="field" name="remark" cols="50" rows="6" style="resize:none"><%=obj.getRemark()%></textarea>
						</td>						
					</tr>
				</tr>
			</table>			
			...
			<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
				<thead id="listTHEAD">
					<tr>
						...
						<th class="listTH"><a class="text_link_w" onClick="return sortTable('listTBODY',2,false);" href="#">產品名稱</a></th>
					</tr>				
				</thead>
				<tbody id="listTBODY">
					<%
