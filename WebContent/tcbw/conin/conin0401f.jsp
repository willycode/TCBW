...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.conin.CONIN0401F">
...
<TABLE STYLE="width:100%;" CELLPADDING=0 CELLSPACING=0>
	<tr>
		<td nowrap ID=t1 CLASS="tab_border2" width="100"><a href="#" onClick="return checkURL('conin0201f.jsp');">身分別資料</a></td>
		<td nowrap ID=t2 CLASS="tab_border1" width="100" HEIGHT="25">身分別權限</td>
		<td nowrap>&nbsp;</td>
	</tr>
	<tr>
