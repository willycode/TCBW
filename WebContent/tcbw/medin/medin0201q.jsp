...
<%
com.kangdainfo.tcbw.view.medin.MEDIN0201F qBean = (com.kangdainfo.tcbw.view.medin.MEDIN0201F) request.getAttribute("qBean");
%>
	...
	<tr>
		...
		<td nowrap class="td_form" width="15%">作業人員：</td>
		<td nowrap class="td_form_white" width="35%">
			<input class="field_Q" type="text" name="q_workers" size="20" maxlength="50" value="<%=qBean.getQ_workers()%>">
		</td>
		<!--  此查詢無作用
	...
	<tr>
		<td nowrap class="td_form" width="15%">作業人員：</td>
		<td nowrap class="td_form_white" width="35%">
			<input class="field_Q" type="text" name="q_workers" size="11" maxlength="50" value="<%=qBean.getQ_workers()%>">
		</td>
		<td nowrap class="td_form" width="15%"></td>
		<td nowrap class="td_form_white" width="35%">
		</td>
	</tr>
	 -->	
