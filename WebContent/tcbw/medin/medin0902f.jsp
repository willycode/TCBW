...
<%@ page import="java.io.*" %>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medin.MEDIN0902F">
...
function init() 
{
	if("Y"==form1.isRCEnd.value)
	{
		window.close();
		window.opener.doBack("0902");	
	}
...
{	
	var alertStr = "";
	alertStr += checkEmpty(form1.reCalibrationReason, "再校正理由");
...
<tr>
	...
	<table class="table_form" width="100%" height="100%">
	    <tr>
			<td nowrap class="td_form_left">資料再校正</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="15%">再校正理由</td>
			<td nowrap class="td_form_white" width="35%">
                <textarea class="field_Q" name="reCalibrationReason" cols="60" rows="5" maxlength="50"><%=obj.getReCalibrationReason()%></textarea>
			</td>
		</tr>
	</table>
	</div>
...
<td nowrap class="bgToolbar"  style="text-align: center">
	...
	<input type="hidden" name="isRCEnd" value="<%=obj.getIsRCEnd()%>">
