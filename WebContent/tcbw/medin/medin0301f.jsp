...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medin.MEDIN0301F">
...
{
	obj = (com.kangdainfo.tcbw.view.medin.MEDIN0301F)obj.queryOne();
}
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
	    ...
	    out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", true,"medin0302f.jsp","&caseType="+caseType,"&statusType="+statusType,1));
