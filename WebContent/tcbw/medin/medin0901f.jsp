...
<%@ page import="java.io.*" %>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medin.MEDIN0901F">
...
{	
	var alertStr = "";
	alertStr += checkEmpty(form1.reason, "再評估理由");
	if(alertStr.length!=0){ alert(alertStr); return false; }
	form1.submit();
	window.close();
	window.opener.doBack("0901");//返回查詢頁面
}
...
<tr>
	...
	<table class="table_form" width="100%" height="100%">
	    <tr>
			<td nowrap class="td_form_left">案件再評估</td>
		</tr>
		<tr>
			<td nowrap class="td_form" width="15%">再評估理由</td>
			<td nowrap class="td_form_white" width="35%">
                <textarea class="field_Q" name="reason" cols="60" rows="5" maxlength="50"><%=obj.getReason()%></textarea>
			</td>
		</tr>
	</table>
	</div>
