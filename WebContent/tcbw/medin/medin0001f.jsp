...
<jsp:include page="../../home/secure.jsp">
	<jsp:param name="DTREE_PROGRAM_IDENTIFIER" value="MEDIN0001" />
</jsp:include>
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medin.MEDIN0001F">
...
if ("queryAll".equals(obj.getState())) {
	...
	obj = (com.kangdainfo.tcbw.view.medin.MEDIN0001F)obj.queryOne();	
...
function init() {
	if(loadfile != ""){
		...
		for(i=0; i<tempFile.length; i++){
			...
			if(i==0)
				addAtt('MEDIN0001F', tempFile[i], false);
			else
				addAtt('MEDIN0001F', tempFile[i], true);
		}
	}else{
		addAtt('MEDIN0001F', '', false);
	}
...
<tr><td nowrap class="bg">
	...
	<tr>
		<td nowrap class="td_form"><font color="red">*</font>文號：</td>
	...
	<tr>
		...
		<td nowrap class="td_form_white">
			<input class="field" type="text" name="subject" size="50" maxlength="50" value="<%=obj.getSubject()%>">
		</td>
	</tr>
	<tr>
		<td nowrap class="td_form">摘要：</td>
		<td nowrap class="td_form_white">
			<textarea class="field" name="summary" cols="100" rows="3" value="<%=obj.getSummary()%>"><%=obj.getSummary()%></textarea>
		</td>
	</tr>
	<tr>
