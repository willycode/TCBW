...
<jsp:useBean id="obj" scope="request" class="com.kangdainfo.tcbw.view.medin.MEDIN0201F">
...
{
	obj = (com.kangdainfo.tcbw.view.medin.MEDIN0201F)obj.queryOne();
}
obj.setQueryAllFlag("true"); 
...
function updateData(id)
{
    ...
    if('<%=statusType%>'=="10" || '<%=statusType%>'=="20" || '<%=statusType%>'=="30")
    {
    	url+="medin0202f.jsp?";
    }
...
<table class="table_form" width="100%" cellspacing="0" cellpadding="0">
	...
	<%
	    ...
	    boolean displayArray[] = {false,true,true,true,true,true,true,false,true};
	    ...
	    out.write(View.getQueryDiscolorList(primaryArray, displayArray,alignArray, objList, obj.getQueryAllFlag(), true, "", true,"medin0202f.jsp","&caseType="+caseType,"&statusType="+statusType,1));
