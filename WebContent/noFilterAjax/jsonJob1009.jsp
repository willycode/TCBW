...
try{	
	java.util.List objList = ServiceGetter.getInstance().getTcbwService().load(" select medAgencyCode, medAgencyName from Con1009Db where (endDate is null or endDate > " + Common.sqlChar(Datetime.getYYYMMDD()) + ")");
