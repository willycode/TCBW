...
public class Med5001DbSearch extends SuperBean{

	private String applNo;
	private String med2001Id;
	

	public String getMed2001Id() {
		return checkGet(med2001Id);
	}

	public void setMed2001Id(String med2001Id) {
		this.med2001Id = checkSet(med2001Id);
	}
	...
	public Object doQueryAll() throws Exception {
		...
		String hql = " from Med5001Db where med2001ID = " + Common.getLong(getMed2001Id());
