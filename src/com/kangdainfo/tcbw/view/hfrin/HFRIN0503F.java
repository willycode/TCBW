...
public class HFRIN0503F extends HFRIN0501F implements HFRIN0002F {
	...
	public Object doQueryOne() throws Exception {
		...
		if(c != null){
			...
			java.util.List<Con0001Db> fileList = ServiceGetter.getInstance().getTcbwService().load(" from Con0001Db where fileKind = 'H' and dbName = 'HFR0001DB' and upLoadId = " + Common.getLong(obj.getId()));
	...
	public void doUpdateType() throws Exception{
		ServiceGetter.getInstance().getTcbwService().getHfrinDao().updateByHFRIN0503F(this);
	}
