...
public class HFRIN0705F extends HFRIN0701F implements HFRIN0002F {
	...
	public void doUpdateType() throws Exception{
		HFRIN0702F ref = new HFRIN0702F();
		org.springframework.beans.BeanUtils.copyProperties(this, ref, new String[]{""});
		ServiceGetter.getInstance().getTcbwService().getHfrinDao().updateByHFRIN0702F(ref);
