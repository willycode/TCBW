...
public class CONIN0701F extends SuperBean{
	...
	public Object doQueryAll() throws Exception {
		...
		String hql = " from Con1014Db where 1 = 1 ";
			...
			if(!"".equals(getQ_name()))
				hql += " and id = " + Common.sqlChar(getQ_name());
...
//					rowArray[5] = Common.get(dtl.getIsStop()).equals("Y")?"是":Common.get(dtl.getIsStop()).equals("N")?"否":"";
	...
	protected String[][] getInsertCheckSQL(){	
		String[][] checkSQLArray = new String[1][4];
	 	checkSQLArray[0][0] = "select count(*) from Con1014Db where code = " + Common.sqlChar(getCode());
		checkSQLArray[0][1] = ">";
		checkSQLArray[0][2] = "0";
