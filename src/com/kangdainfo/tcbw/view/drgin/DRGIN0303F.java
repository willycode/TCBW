...
public class DRGIN0303F extends DRGIN0302F{
	...
	public Object doQueryAll() throws Exception {		
		...
		if("1".equals(getCaseType())){
			hql += " and status in ('20')";
		}else if("2".equals(getCaseType())){
			hql += " and status in ('21','22','23')";
		}
		...
		if(objList!=null && objList.size()>0)
		{
			...
			for(Object dtlObj : objList)
			{
				...
				//rowArray[10] =  "<input type='button' class='toolbar_default' name='btn_Data' value='明　細' onClick=\"listContainerRowClick('"+dtl.getId()+"');queryOne('" + dtl.getId() + "');\"> ";
