...
public class DRGIN0108F extends SuperBean{
	...
	{
		Drg0001Db obj = (Drg0001Db)View.getObject(" from Drg0001Db where id = " + Common.getLong(getId1()));
		if(obj!=null)
		{
			obj.setChargeMan(getUserid());
		}	
