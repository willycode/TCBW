...
public class HFREX0102F extends HFREX0101F {
	...
	public void doInsert()throws Exception{
		ServiceGetter.getInstance().getTcbwService().getHfrexDao().insertByHFREX0102F(this);
	}
	...
	public void doUpdateType() throws Exception{
		ServiceGetter.getInstance().getTcbwService().getHfrexDao().updateByHFREX0102F(this, false);
	}
	
	public void doDelete() throws Exception{
		ServiceGetter.getInstance().getTcbwService().getHfrexDao().deleteByHFREX0102F(this);
	}
