...
public class MEDIN0601F extends MEDIN0602F
{
			...
			if (objList != null && objList.size() > 0) 
			{
				...
				{				
				    ...
				    {	
				      ...
				      {	  
					    String date = Datetime.getDateAdd("d",Integer.valueOf(sys0001Db.getField5()),dtl.getNotifierRevDate());
					    if(Common.getInt(Datetime.getYYYMMDD()) > Common.getInt(date)) 
					    	light="<img width='30px' src='../../images/ballRed.png'>";
				      }
				      else
				      {
				    	String date = Datetime.getDateAdd("m",Integer.valueOf(sys0001Db.getField6()),dtl.getNotifierRevDate());
						if(Common.getInt(Datetime.getYYYMMDD()) > Common.getInt(date)) 
							light="<img width='30px' src='../../images/ballRed.png'>";
				      }	  
