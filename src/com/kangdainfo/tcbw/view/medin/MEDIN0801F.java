...
public class MEDIN0801F extends SuperBean
{
...
//		}
		...
		System.out.println("[TCBW]-[MEDIN0801F]-[QUERYALL] : " + hql);
			...
			if (objList != null && objList.size() > 0) 
			{
				...
				{				
					...
					{	
					   ...
					   if("A".equals(dtl.getEventClass()))	
					   {	  
						  String date = Datetime.getDateAdd("d",Integer.valueOf(sys0001Db.getField7()),dtl.getNotifierRevDate());
						  if(Common.getInt(Datetime.getYYYMMDD()) > Common.getInt(date)) 
						    light="<img width='30px' src='../../images/ballRed.png'>";
					   }
					   else
					   {
					      String date = Datetime.getDateAdd("m",Integer.valueOf(sys0001Db.getField8()),dtl.getNotifierRevDate());
						  if(Common.getInt(Datetime.getYYYMMDD()) > Common.getInt(date)) 
							light="<img width='30px' src='../../images/ballRed.png'>";
					   }	  
