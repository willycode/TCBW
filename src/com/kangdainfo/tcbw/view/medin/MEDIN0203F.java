...
public class MEDIN0203F extends SuperBean{
	...
	private String q_status;//來源案件狀態
	...
	public Object doQueryAll() throws Exception 
	{
		...
		hql += " and competence like " + TCBWCommon.likeSqlChar("2");
		...
		//只有status=71(評估確認中)要排除掉上一個人
		if("71".equals(getQ_status())){
			String lastUser = View.getLookupField("select userID from Con2001Db where systemType like 'MED%' and formID = "+getId1()+" order by id desc");
			hql += " and commonUser.userId <> " + Common.sqlChar(lastUser);
		}
	...
	{
		Med0001Db obj = (Med0001Db)View.getObject(" from Med0001Db where id = " + Common.getLong(getId1()));
		if(obj!=null)
		{
