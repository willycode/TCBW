...
public class MEDIN0701F extends SuperBean
{
...
//		}
		...
		System.out.println("[TCBW]-[MEDIN0701F]-[QUERYALL] : " + hql);
		...
		if (getTotalRecord() > 0)
		{
			...
			if (objList != null && objList.size() > 0) 
			{
				...
				{				
				    ...
				    if(sys0001Db!=null)
				    {	
					  String date = Datetime.getDateAdd("m",Integer.valueOf(sys0001Db.getField4()),dtl.getNotifierRevDate());
