...
public class SDRG0701Q extends SDRG0601F{
	...
	public Object doQueryOne0701() throws Exception {
		SDRG0701Q obj = this;

		Drg8001Db c = (Drg8001Db) View.getObject(" from Drg8001Db where id=" + Common.getInt(obj.getId()));
		
		//System.out.println("[TCBW]-[SDRG0701F]-[doQueryOne]- Drg8001Db.id : " + obj.getId());
	...
	public Object doQueryAll() throws Exception {		
		...
		if(!"".equals(getQ_isTrans())){
			if("Y".equals(getQ_isTrans())) hql += " and a.isTransferData='Y' ";
			else if ("N".equals(getQ_isTrans())) hql += " and ( a.isTransferData is null or a.isTransferData='' ) ";
		}
		System.out.println("[TCBW]-[SDRG0701Q]-[QUERYALL] : " + hql);
		...
		if (getTotalRecord() > 0) 
		{
			...
			{
				java.util.Map<String, String> statusMap = TCBWCommon.getCommonCodeMap("DRGEVSTATUS");
				...
				for(Object dtlObj : objList)
				{
					...
					rowArray[12] =  "<div class='discolor'><a href='sdrg0701f.jsp?id="+Common.get(dtl.getId())+"'>"+"明細"+"</a></div>";
