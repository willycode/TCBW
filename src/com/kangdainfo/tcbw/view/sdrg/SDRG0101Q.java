...
public class SDRG0101Q extends SuperBean{
	...
	public Object doQueryAll() throws Exception {		
		...
		if(!"".equals(getQ_healthbureau()))
			hql += " and ( a.healthbureau1 like " + Common.sqlChar(getQ_healthbureau()+"%")+
			       " or a.healthbureau2 like "+ Common.sqlChar(getQ_healthbureau()+"%")+" )";		
