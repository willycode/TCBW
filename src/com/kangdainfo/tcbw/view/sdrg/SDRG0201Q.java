...
public class SDRG0201Q extends SuperBean{
	...
	public Object doQueryAll() throws Exception {		
		...
		String hql = " from Drg8001Db a  where  a.status='10' ";
...
//			hql += " and a.status = " + Common.sqlChar(getQ_status());
		...
		System.out.println("[TCBW]-[SDRG0201Q]-[QUERYALL] : " + hql);
		...
		if (getTotalRecord() > 0) 
		{
			...
			{				
				...
				for(Object dtlObj : objList)
				{
					...
					rowArray[11] =  "<div class='discolor'><a href='sdrg0201f.jsp?id="+Common.get(dtl.getId())+"'>"+"明細"+"</a></div>";
