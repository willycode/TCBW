...
public class SDRG0601Q extends SuperBean{
	...
	public Object doQueryAll() throws Exception {		
		...
		hql += " and a.id in (select drg8001Db.id from Drg8004Db where status in ('60') )";
...
//		}
		...
		System.out.println("[TCBW]-[SDRG0601Q]-[QUERYALL] : " + hql);
		...
		if (getTotalRecord() > 0) 
		{
			...
			{				
				...
				for(Object dtlObj : objList)
				{
					...
					rowArray[11] =  "<div class='discolor'><a href='sdrg0601f.jsp?id="+Common.get(dtl.getId())+"'>"+"明細"+"</a></div>";
