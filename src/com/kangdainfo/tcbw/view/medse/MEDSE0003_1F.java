...
public class MEDSE0003_1F extends MEDSE0003F{
	...
	{
		MEDSE0003_1F obj = this;
		Med1005Db m = (Med1005Db)View.getObject("from Med1005Db where id = " + Common.getLong(getId2()));		
		if(m != null)
		{
...
//				java.util.Map<String, String> sysMap = TCBWCommon.getCommonCodeMap("SYS");
	...
	public void doUpdate() throws Exception {
		Med1005Db obj = (Med1005Db)View.getObject(" from Med1005Db where id = " + Common.getLong(getId2()));
		if(obj != null){		
			obj.setCode(getLevel2code());
			obj.setName(getName2());
			obj.setTerm(getTerm2());
