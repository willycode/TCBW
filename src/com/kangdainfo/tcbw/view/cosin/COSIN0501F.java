...
public class COSIN0501F extends COSIN1001F {
	
	public Object doQueryAll() throws Exception {
		java.util.ArrayList<String[]> arrList = new java.util.ArrayList<String[]>();
		
		String hql = " from Cos0001Db where status = '40' ";
		if("1P".equals(getQ_type())){
			hql += " and cosType = '1' ";
		}else{
			hql += " and cosType = '2' ";
		}
		...
		System.out.println("[TCBW]-[COSIN0501F]-[QUERYALL] : " + hql + " order by id ");
