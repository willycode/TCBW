...
public class Med0010Db  implements Serializable 
{
    /** identifier field */
    private Long id;
    ...
    private String replyDate;//回復日期
    private String replyContent;
    
    private String medPermitFirmCode;
    private String medCountry;
