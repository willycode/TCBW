...
public class Drg4001Db  implements Serializable 
{
	/** identifier field */
    private Long id;
	...
	private Set drg4002Dbs;
	private Set drg4003Dbs;
	...
	public Set getDrg4002Dbs() {
		return drg4002Dbs;
	}

	public void setDrg4002Dbs(Set drg4002Dbs) {
		this.drg4002Dbs = drg4002Dbs;
	}

	public Set getDrg4003Dbs() {
		return drg4003Dbs;
	}

	public void setDrg4003Dbs(Set drg4003Dbs) {
		this.drg4003Dbs = drg4003Dbs;
	}
	...
	public String toString() {
		return "Drg4001Db [id=" + id + ", applNo=" + applNo + ", status="
				+ status + ", chargeMan=" + chargeMan + ", occurDate="
				+ occurDate + ", isComplete=" + isComplete
				+ ", notifierRevDate=" + notifierRevDate + ", notifierRepDate="
				+ notifierRepDate + ", notifierSource=" + notifierSource
				+ ", notifierName=" + notifierName + ", notifierDept="
				+ notifierDept+ ", notifierDeptID=" + notifierDeptID
				+ ", notifierTel=" + notifierTel
				+ ", notifierAddress=" + notifierAddress + ", notifierEmail="
				+ notifierEmail + ", notifierPhone=" + notifierPhone
				+ ", notifierFax=" + notifierFax + ", notifierType="
				+ notifierType + ", notifierTitle=" + notifierTitle
				+ ", patientId=" + patientId + ", patientSex=" + patientSex
				+ ", patientBirth=" + patientBirth + ", patientAge="
				+ patientAge + ", patientHeight=" + patientHeight
				+ ", patientWeight=" + patientWeight + ", conSequence="
				+ conSequence + ", effectChange=" + effectChange
				+ ", effectChangeDesc=" + effectChangeDesc + ", badReaction="
				+ badReaction + ", badReactionLev=" + badReactionLev
				+ ", badReactionDesc=" + badReactionDesc + ", beforeDesc="
				+ beforeDesc + ", changeDesc=" + changeDesc + ", occurDesc="
				+ occurDesc + ", afterDesc=" + afterDesc + ", otherDesc="
				+ otherDesc + ", dealWith=" + dealWith + ", dealWithOther="
				+ dealWithOther + ", isImproveYn=" + isImproveYn
				+ ", dressingAttitude=" + dressingAttitude + ", obedienceLev="
				+ obedienceLev + ", enrolledDate=" + enrolledDate
				+ ", isContactYn=" + isContactYn + ", receiveSystem="
				+ receiveSystem + ", receiveDate=" + receiveDate
				+ ", receiveTime=" + receiveTime + ", creator=" + creator
				+ ", createDate=" + createDate + ", createTime=" + createTime
				+ ", modifier=" + modifier + ", modifyDate=" + modifyDate
				+ ", modifyTime=" + modifyTime + ", drg4002Dbs=" + drg4002Dbs
				+ ", drg4003Dbs=" + drg4003Dbs + ", drg4008Dbs=" + drg4008Dbs
				+ ", drg4010Dbs=" + drg4010Dbs + ", drg4011Dbs=" + drg4011Dbs
