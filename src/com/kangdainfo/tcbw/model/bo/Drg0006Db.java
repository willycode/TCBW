...
public class Drg0006Db  implements Serializable 
{
    ...
    private String defectOther;	//不良品缺陷(其他)
    private String survey;	//調查結果
    private String surveyOther;	//調查結果(其他)
    private String precaution;	//預防措施
    private String precautionOther;	//預防措施(其他)
