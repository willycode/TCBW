...
public class Con1009Db  implements Serializable 
{
    /** identifier field */
    private Long id;

    /** persistent field */
    private String bnhi;//分局別
    private String medAgencyCode;//醫事機構代碼
	private String medAgencyName;//醫事機構名稱
    private String agencyAddress;//機構地址
    private String areaTel;//電話區域號碼
    private String tel;//電話號碼
    private String engageKind;//特約類別
    private String medAgencyKind;//醫事機構種類   
    private String endDate;//終止合約或歇業日期
