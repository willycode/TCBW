...
public class Cos0001Db  implements Serializable 
{
	/** identifier field */
    private Long id;
    private Long cos4001DbId;
    private Long con1003DbId;
    private String foreignApplNo;
    ...
    private String otherIsDamageYn;//是否有損害使用者身體或健康之事實-其他(說明)
	...
	private Set cos0002Dbs;
	private Set cos0003Dbs;
	...
	public Long getCos4001DbId() {
		return cos4001DbId;
	}

	public void setCos4001DbId(Long cos4001DbId) {
		this.cos4001DbId = cos4001DbId;
	}
	...
	public String getForeignApplNo() {
		return foreignApplNo;
	}

	public void setForeignApplNo(String foreignApplNo) {
		this.foreignApplNo = foreignApplNo;
	}
	...
	public String getIsSend06Mail() {
		return isSend06Mail;
	}

	public void setIsSend06Mail(String isSend06Mail) {
		this.isSend06Mail = isSend06Mail;
	}
	...
	public Set getCos0002Dbs() {
		return cos0002Dbs;
	}

	public void setCos0002Dbs(Set cos0002Dbs) {
		this.cos0002Dbs = cos0002Dbs;
	}

	public Set getCos0003Dbs() {
		return cos0003Dbs;
	}

	public void setCos0003Dbs(Set cos0003Dbs) {
		this.cos0003Dbs = cos0003Dbs;
	}
	...
	public String toString() 
	{
		...
		builder.append("Cos0001Db [id=");
		builder.append(id);
		builder.append(", cos4001DbId=");
		builder.append(cos4001DbId);
		builder.append(", applNo=");
		builder.append(applNo);
		builder.append(", foreignApplNo=");
		builder.append(foreignApplNo);
