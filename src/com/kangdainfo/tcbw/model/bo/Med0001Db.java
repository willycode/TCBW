...
public class Med0001Db  implements Serializable 
{
	/** identifier field */
    private Long id;
    private String autoReUpdate;
    private String applNo;//案件號碼
    private String applNo1;//對方案件號碼
    ...
    private String ncarResult;//NCAR通報狀況
    private String eventClass;//不良品事件等級
    private String bulletinQuality;//通報品質
    private String medicalIssues;//醫材問題代碼
    
    private String isReCalibration;//是否為再校正案件
    private String reCalibrationReason;//再校正理由
    
    private String medEname;//醫療器材名稱(英文) 
    ...
    private String workers;//作業人員
    
    private String isExcelUpdate;//是否有Excel轉入補強資料
    
    private String isTransferAdr;
    private String adrCaseNo;
    
    private Set med0002Dbs;
	private Set med0003Dbs;
	private Set med0004Dbs;
	private Set med0005Dbs;
	private Set med0006Dbs;
	private Set med0007Dbs;
	private Set med0008Dbs;
	private Set med0009Dbs;
	private Set med0010Dbs;
	
	public Set getMed0002Dbs() {
		return med0002Dbs;
	}

	public void setMed0002Dbs(Set med0002Dbs) {
		this.med0002Dbs = med0002Dbs;
	}

	public Set getMed0003Dbs() {
		return med0003Dbs;
	}

	public void setMed0003Dbs(Set med0003Dbs) {
		this.med0003Dbs = med0003Dbs;
	}

	public Set getMed0004Dbs() {
		return med0004Dbs;
	}

	public void setMed0004Dbs(Set med0004Dbs) {
		this.med0004Dbs = med0004Dbs;
	}
	
	public Set getMed0005Dbs() {
		return med0005Dbs;
	}

	public void setMed0005Dbs(Set med0005Dbs) {
		this.med0005Dbs = med0005Dbs;
	}
    
    
	
	public Set getMed0006Dbs() {
		return med0006Dbs;
	}

	public void setMed0006Dbs(Set med0006Dbs) {
		this.med0006Dbs = med0006Dbs;
	}

	public Set getMed0007Dbs() {
		return med0007Dbs;
	}

	public void setMed0007Dbs(Set med0007Dbs) {
		this.med0007Dbs = med0007Dbs;
	}

	public Set getMed0008Dbs() {
		return med0008Dbs;
	}

	public void setMed0008Dbs(Set med0008Dbs) {
		this.med0008Dbs = med0008Dbs;
	}

	public Set getMed0009Dbs() {
		return med0009Dbs;
	}

	public void setMed0009Dbs(Set med0009Dbs) {
		this.med0009Dbs = med0009Dbs;
	}

	
	
	
	public Set getMed0010Dbs() {
		return med0010Dbs;
	}

	public void setMed0010Dbs(Set med0010Dbs) {
		this.med0010Dbs = med0010Dbs;
	}
	...
	public void setIsReCalibration(String isReCalibration) {
		this.isReCalibration = isReCalibration;
	}
	
	public String getReCalibrationReason() {
		return reCalibrationReason;
	}

	public void setReCalibrationReason(String reCalibrationReason) {
		this.reCalibrationReason = reCalibrationReason;
	}
	...
	public void setAutoReUpdate(String autoReUpdate) {
		this.autoReUpdate = autoReUpdate;
	}
	...
	public String getIsTransferAdr() {
		return isTransferAdr;
	}

	public void setIsTransferAdr(String isTransferAdr) {
		this.isTransferAdr = isTransferAdr;
	}

	public String getAdrCaseNo() {
		return adrCaseNo;
	}

	public void setAdrCaseNo(String adrCaseNo) {
		this.adrCaseNo = adrCaseNo;
	}
	...
	public String toString() 
	{
		...
		builder.append(isReCalibration);
		builder.append(", reCalibrationReason=");
		builder.append(reCalibrationReason);
