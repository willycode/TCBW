...
public class Drg5001Db  implements Serializable 
{
	/** identifier field */
    private Long id;

    private Long drg0001Id; //內部主檔ID
    private String revision;//版次	VARCHAR(3)
    private String autoReUpdate; // 是否主動補件
	...
	public Long getDrg0001Id() {
		return drg0001Id;
	}

	public void setDrg0001Id(Long drg0001Id) {
		this.drg0001Id = drg0001Id;
	}
	...
	public Set getDrg5002Dbs() {
		return drg5002Dbs;
	}

	public void setDrg5002Dbs(Set drg5002Dbs) {
		this.drg5002Dbs = drg5002Dbs;
	}
	...
	public String toString() 
	{
		...
		builder.append("Drg5001Db [id=");
		builder.append(id);
		builder.append(", drg0001Id=");
		builder.append(drg0001Id);
		builder.append(", revision=");
		builder.append(revision);
		builder.append(", autoReUpdate=");
		builder.append(autoReUpdate);
