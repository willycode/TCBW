...
public class Drg1001Db  implements Serializable 
{
	/** identifier field */
    private Long id;
	...
	private String isCheckFile;//是否檢查附件
	...
	public String getIsCheckFile() {
		return isCheckFile;
	}

	public void setIsCheckFile(String isCheckFile) {
	...
	public String toString() 
	{
		...
		builder.append("Drg1001Db [id=");
		builder.append(id);
		builder.append(", dpdKind=");
		builder.append(dpdKind);
		builder.append(", dpdKindName=");
		builder.append(dpdKindName);
		builder.append(", isCheckFile=");
		builder.append(isCheckFile);
